...
public class SmsUtil {
    ...
    //替换成你的AK
    static final String accessKeyId = "LTAIii1c04bhuQko";//你的accessKeyId,参考本文档步骤2
    static final String accessKeySecret = "PFS15rnzhvwsYZpmUFIwueqX0VRtBy";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String sendSms(String phone) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("李文涛");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_137659544");
